...
\noindent Each user is automatically assigned a personal scratch directory at
\texttt{/speed-scratch/\$USER}. You can verify that it exists by running:
\begin{verbatim}
    ls -ld /speed-scratch/$USER
\end{verbatim}

\noindent If the directory does not exist, please contact \texttt{rt-ex-hpc AT encs.concordia.ca} for assistance.

\noindent You can change to your scratch directory with:
\begin{verbatim}
...
If you would like to use \tool{bash}, please contact \texttt{rt-ex-hpc AT encs.concordia.ca} for assistance.
